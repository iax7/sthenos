...
<template>
  <ViewContainer class="max-w-sm">
    <div class="flex items-center gap-2">
      <UserCircleIcon class="size-8 text-gray-700" />
      <h1 class="text-2xl font-bold text-gray-800">{{ t('profile.title') }}</h1>
    </div>
    <AppCard>
        ...
        <div class="flex flex-col">
          ...
          <div class="flex gap-2">
            <label class="relative flex-1 cursor-pointer">
              <input type="radio" class="peer opacity-0 absolute" value="M" v-model="gender" required />
              <span
                class="block rounded-lg border px-4 py-2 text-center transition border-gray-200 bg-gray-50 hover:bg-gray-100 peer-checked:border-blue-500 peer-checked:bg-blue-50/80 peer-checked:shadow-sm font-medium text-gray-800">
                {{ t('profile.male') }}
              </span>
            </label>
            <label class="relative flex-1 cursor-pointer">
              <input type="radio" class="peer opacity-0 absolute" value="F" v-model="gender" required />
              <span
                class="block rounded-lg border px-4 py-2 text-center transition border-gray-200 bg-gray-50 hover:bg-gray-100 peer-checked:border-blue-500 peer-checked:bg-blue-50/80 peer-checked:shadow-sm font-medium text-gray-800">
                {{ t('profile.female') }}
              </span>
