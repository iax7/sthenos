...
import { calculatePoints, calculateCooperPoints, getTestScore, getExerciseKeys, getVersion, getReps } from '@/services/exercises'
...
const totalScore = computed(() => {
  ...
  return getTestScore(test.value, profile.value)
})
